...
public class EnumLocalizerConverter : IValueConverter
{
	public object? Convert(object? value, Type targetType, object? parameter, CultureInfo culture)
	{
		return value switch
		{
			...
			FilterSource.Unfiltered => Strings.PingUI_Models_FilterSource_Unfiltered,
			FilterSource.Label => Strings.PingUI_Models_FilterSource_Label,
			FilterSource.Address => Strings.PingUI_Models_FilterSource_Address,
			FilterSource.AnyTag => Strings.PingUI_Models_FilterSource_AnyTag,
			FilterSource.AllTags => Strings.PingUI_Models_FilterSource_AllTags,
			FilterSource.And => Strings.PingUI_Models_FilterSource_And,
			FilterSource.Or => Strings.PingUI_Models_FilterSource_Or,
			FilterSource.Not => Strings.PingUI_Models_FilterSource_Not,
